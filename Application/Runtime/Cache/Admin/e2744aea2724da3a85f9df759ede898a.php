            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="title_font_color">
                  ...
                  <?php if(is_array($titleFontColor)): $i = 0; $__LIST__ = $titleFontColor;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$color): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($color); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="catid">
                  <?php if(is_array($webSiteMenu)): $i = 0; $__LIST__ = $webSiteMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sitenav): $mod = ($i % 2 );++$i;?><option value="<?php echo ($sitenav["menu_id"]); ?>"><?php echo ($sitenav["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="copyfrom">
                  <?php if(is_array($copyFrom)): $i = 0; $__LIST__ = $copyFrom;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cfrom): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($cfrom); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
